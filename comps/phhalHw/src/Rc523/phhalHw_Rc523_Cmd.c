                                     ...
                                     )
{
    ...
    /* Check options */
    if (wOption &
            (uint16_t)~(uint16_t)(PHHAL_HW_RC523_OPTION_RXTX_TIMER_START
    ...
    if (wOption & (PHHAL_HW_RC523_OPTION_RXTX_TIMER_START | PHHAL_HW_OPTION_START_CMD_ONLY))
    {
    ...
    if (wOption & (PHHAL_HW_RC523_OPTION_RXTX_TIMER_START | PHHAL_HW_OPTION_FIFO_READ))
    {
