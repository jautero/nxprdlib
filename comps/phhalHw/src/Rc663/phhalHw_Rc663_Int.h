...
/**
* \brief Enables testmode in Rc663. This is required for operating in ISO18000p3m3 mode
*
* \return Status code
* \retval #PH_ERR_SUCCESS Operation successful.
* \retval Other Depending on implementation and underlaying component.
...
/**
* \brief Unlock Rc663 registers for modifying the protected register content. This is a bug in RC663 h/w
*
* \return Status code
* \retval #PH_ERR_SUCCESS Operation successful.
* \retval Other Depending on implementation and underlaying component.
