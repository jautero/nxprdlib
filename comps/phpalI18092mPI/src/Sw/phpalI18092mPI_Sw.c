...
* $Author: nxp40786 $
* $Revision: 342 $
* $Date: 2013-08-11 09:08:09 +0530 (Sun, 11 Aug 2013) $
*
* History:
                                 ...
                                 )
{
    ...
    if (((phhalHw_GetConfig(pDataParams->pHalDataParams, PHHAL_HW_CONFIG_RX_FRAME_MODE, &wRegister)) & PH_ERR_MASK) == PH_ERR_SUCCESS)
    {
        if (wRegister == PHHAL_HW_ACTIVE_MODE_FRAMING)
        {
            /* set the active mode variable */
        ...
        case PHPAL_I18092MPI_SW_STATE_INFORMATION_PDU_TX:
            ...
            else
            {
                ...
                if (!(wHalExchangeOption & PH_EXCHANGE_BUFFERED_BIT))
                {
                    ...
                    /* In Active mode the start byte would be removed */
                                       ...
                                       )
{
    ...
    case PHPAL_I18092MPI_CONFIG_ACTIVEMODE:
        ...
        PH_CHECK_SUCCESS_FCT(status, phhalHw_SetConfig(pDataParams->pHalDataParams,  PHHAL_HW_CONFIG_ACTIVEMODE, wValue));
        break;
    ...
    case PHPAL_I18092MPI_CONFIG_ATN:
    	...
    	pDataParams->bAtnDisabled = (uint8_t)(wValue ^ 0x0001);
    	break;
                                       ...
                                       )
{
    ...
    case PHPAL_I18092MPI_CONFIG_ATN:
    	*pValue = (uint16_t)(pDataParams->bAtnDisabled ^ 0x01);
    	break;
