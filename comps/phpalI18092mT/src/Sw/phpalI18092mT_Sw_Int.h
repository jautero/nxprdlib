...
#define PHPAL_I18092MT_SW_IS_ATTENTION(bPfb)                                                            \
    ((                                                                                                  \
    (((bPfb) & PHPAL_I18092MT_SW_PFB_PDU_TYPE_MASK) == PHPAL_I18092MT_SW_PFB_SUPERVISORY_PDU_MASK) &&   \
    (((bPfb) & PHPAL_I18092MT_SW_PFB_OPTION_MASK) == 0x00))                                             \
    ? 1 : 0                                                                                             \
    )
...
/** Gt_available bit wihtin PP(I) byte of ATR_REQ. */
...
/** NAD_used bit wihtin PP(I) byte of ATR_REQ. */
...
#define PHPAL_I18092MT_SW_MAX_RETRIES                  5U

/** Default (=minimum) Maximum Retry count, NFCForum-TS-DigitalProtocol-1.0 section A.10. */
#define PHPAL_I18092MT_SW_MAX_RETRIES_DEFAULT          2U
...
/** Autocoll retry max value */
#define PHPAL_I18092MT_SW_MAX_AUTOCOLL_RETRY_COUNT     0x05U

/** Autocoll retry min value */
#define PHPAL_I18092MT_SW_MIN_AUTOCOLL_RETRY_COUNT     0x00U
...
void phpalI18092mT_Sw_RtoxCallBck(
        uint32_t TimerId,
        void *pContext);
