...
* $Author: nxp65585 $
* $Revision: 335 $
* $Date: 2013-08-08 19:01:20 +0530 (Thu, 08 Aug 2013) $
*
* History:
...
typedef struct
{
    ...
    uint8_t bActiveMode;                                /** < Active Mode configuration Bit */
...
/** \defgroup phpalI18092mPI ISO/IEC 18092 Mode Passive Initiator
...
*/
#define PHPAL_I18092MPI_CONFIG_ACTIVEMODE        0x0006U
/**
* \brief Set / Get ATN configuration.
*/
#define PHPAL_I18092MPI_CONFIG_ATN        		 0x0007U
/*@}*/
